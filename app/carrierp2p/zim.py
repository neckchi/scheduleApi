...
async def get_zim_p2p(client:HTTPXClientWrapper, background_task:BackgroundTasks,url: str, turl: str, pw: str, zim_client: str, zim_secret: str, pol: str, pod: str,
    ...
    zim_response_uuid = uuid5(NAMESPACE_DNS,str(params)+str(direct_only)+str(vessel_imo)+str(service)+str(tsp))
    ...
    if response_cache is None:
        ...
        if response_json:
            ...
            background_task.add_task(db.set, key=zim_response_uuid, value=total_schedule_list) if total_schedule_list else ...
