...
async def get_hlag_p2p(client:HTTPXClientWrapper,background_task:BackgroundTasks, url: str, turl: str,user:str, pw: str, client_id: str,client_secret:str,pol: str, pod: str,search_range: int,
    ...
    hlag_response_uuid = uuid5(NAMESPACE_DNS,str(params)+str(service)+str(tsp))
    ...
    if response_cache is None:
        ...
        if response_json:
            ...
            background_task.add_task(db.set, key=hlag_response_uuid,value=total_schedule_list) if total_schedule_list else ...
