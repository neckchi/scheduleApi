...
resource "aws_secretsmanager_secret_version" "this" {
  ...
  secret_string = jsonencode({
    ...
    HLCU_TOKEN_URL     = data.sops_file.sops-secret.data["HLCU_TOKEN_URL"]
    ...
    HLCU_USER_ID       = data.sops_file.sops-secret.data["HLCU_USER_ID"]
    HLCU_PASSWORD      = data.sops_file.sops-secret.data["HLCU_PASSWORD"]
    HLCU_URL           = data.sops_file.sops-secret.data["HLCU_URL"]
